...
export default function Home(): React.JSX.Element {
  ...
  const latestNews: News[] = [
    { id: 1, title: "春の特別展示のお知らせ", content: "内容", createdAt: "2024-01-01" },
    { id: 2, title: "臨時休城のお知らせ", content: "内容", createdAt: "2024-01-02" },
    { id: 3, title: "新しいイベント情報", content: "内容", createdAt: "2024-01-03" },
  ];
  ...
  return (
    <>
      ...
      {/* 紹介文セクション (重なり防止のため h-auto + pb に調整) */}
      <motion.div
        ...
        <section>
          ...
          >
            <div className='flex items-center'>
              <motion.div className='h-[10vh] md:h-[12.5vh] lg:h-[14vh] w-px bg-black mr-[4vw] mt-[-25vh] md:mt-[-38vh] lg:mt-[-44vh] xl:mt-[-54vh]' variants={slideInLeft} initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} />
              ...
              <motion.div className='h-[10vh] md:h-[12.5vh] lg:h-[14vh] w-px bg-black ml-[4vw] mt-[25vh] md:mt-[38vh] lg:mt-[44vh] xl:mt-[54vh]' variants={slideInRight} initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} />
            </div>
          </motion.div>

          <motion.div className='mt-[5vh] md:mt-[6vh] lg:mt-[5vh] xl:mt-[4vh]' variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
            <motion.p className='text-bold font-yuji text-base md:text-lg lg:text-xl xl:text-2xl mx-8 md:mx-16 lg:mx-20 xl:mx-24' variants={fadeInUp}>
              鏡花水月城は、四季の移ろいとともに姿を変える美の城。春には桜が城を淡く包み、夏は深緑と共に清らかな風が吹く。秋は紅葉が石垣を染め、冬は静寂の雪が幻想を映す。一年を通して、自然が織りなす色彩の物語がここにある。
            </motion.p>
          </motion.div>
      ...
      >
        <section>
          ...
          <motion.div className='mt-[7vh] md:mt-[6vh] lg:mt-[5vh] xl:mt-[4vh] space-y-8' variants={staggerContainer}>
            {/* 開場時間 */}
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                <p>開城時間</p>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
                <p>毎週火曜日（祝日の場合は翌日）</p>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
                <p>見学 約60〜90分</p>
              </motion.div>
            </motion.div>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>
                <p>一般：800円</p>
                <p>高校生以下：400円</p>
                <p>未就学児：無料</p>
              </motion.div>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>
                <p>〒000-0000</p>
                <p>黒霞県 夢見郷 影之町一丁目</p>
                <p>幽城台112番地</p>
              </motion.div>
            ...
            <motion.div className='text-center font-bold font-yuji px-[4vw] lg:px-[2.8vw] xl:px-[2.4vw] lg:text-xl xl:text-2xl' variants={fadeInUp} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <motion.div className='text-black py-[2vh] lg:py-[3vh] xl:py-[4vh] lg:text-lg xl:text-xl' initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.7 }}>
                <p>電車でお越しの場合</p>
